...
export default function Contact() {
  ...
  if (status === 'success') {
    return (
      <section className="py-24 px-6 flex items-center justify-center min-h-[60vh]">
        <div className="glass p-12 rounded-3xl text-center max-w-lg animate-fade-up">
  ...
  return (
    <section id="contact" className="py-12 md:py-24 px-6 bg-[#0d0d15] relative overflow-hidden">
      {/* Background Decorative Element */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-purple-600/5 blur-[120px] rounded-full -z-10" />

      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="font-mono text-xs text-purple-400 tracking-widest uppercase">05. contact</span>
          <h2 className="mt-2 text-3xl md:text-4xl font-extrabold text-white">Get In Touch</h2>
          <div className="mt-3 w-12 h-0.5 bg-gradient-to-r from-purple-500 to-cyan-500 mx-auto" />
          <p className="mt-8 text-slate-400 max-w-xl mx-auto leading-relaxed text-sm md:text-base">
            I'm currently looking for new opportunities. Whether you have a project in mind or just want to chat, my inbox already has its own logic!
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
              {[
                ...
                <a
                  ...
                  rel="noreferrer"
                  className="flex items-center gap-4 text-slate-400 hover:text-purple-400 transition-colors group p-2 rounded-xl hover:bg-white/5"
                >
            ...
            <form onSubmit={handleSubmit} className="glass p-6 md:p-8 rounded-2xl border border-white/5 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-purple-600/50 focus:ring-1 focus:ring-purple-600/20 transition-all"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-purple-600/50 focus:ring-1 focus:ring-purple-600/20 transition-all resize-none"
                />
              </div>
